...
C------------------------------------------------------------------
      DOUBLE PRECISION, parameter :: FOUR=4.D0, ONE=1.D0, HALF=0.5D0
      DOUBLE PRECISION, parameter :: TWO=2.D0, ZERO=0.D0, SIXTEN=16.D0
...
C------------------------------------------------------------------
     ...
     1    (/.16112374387056560D00,1.13864154151050156D02,
     2    3.77485237685302021D02,3.20937758913846947D03,
     3    1.85777706184603153D-1/)
      DOUBLE PRECISION, parameter :: B(4) =
     1    (/2.36012909523441209D01,2.44024637934444173D02,
     2    1.28261652607737228D03,2.84423683343917062D03/)
C------------------------------------------------------------------
C  Coefficients for approximation to  erfc  in second interval
C------------------------------------------------------------------
      DOUBLE PRECISION, parameter :: C(9) =
     1    (/5.64188496988670089D-1,8.88314979438837594D0,
     2    6.61191906371416295D01,2.98635138197400131D02,
     3    8.81952221241769090D02,1.71204761263407058D03,
     4    2.05107837782607147D03,1.23033935479799725D03,
     5    2.15311535474403846D-8/)
      DOUBLE PRECISION, parameter :: D(8) =
     1    (/1.57449261107098347D01,1.17693950891312499D02,
     2    5.37181101862009858D02,1.62138957456669019D03,
     3    3.29079923573345963D03,4.36261909014324716D03,
     4    3.43936767414372164D03,1.23033935480374942D03/)
C------------------------------------------------------------------
C  Coefficients for approximation to  erfc  in third interval
C------------------------------------------------------------------
      DOUBLE PRECISION, parameter :: P(6) =
     1    (/3.05326634961232344D-1,3.60344899949804439D-1,
     2    1.25781726111229246D-1,1.60837851487422766D-2,
     3    6.58749161529837803D-4,1.63153871373020978D-2/)
      DOUBLE PRECISION, parameter :: Q(5) =
     1    (/2.56852019228982242D00,1.87295284992346047D00,
     2    5.27905102951428412D-1,6.05183413124413191D-2,
     3    2.33520497626869185D-3/)
C------------------------------------------------------------------
      X = ARG
      Y = ABS(X)
      IF (Y .LE. THRESH) THEN
...
C--------------------------------------------------------------------
      ...
      real(dp) elemental FUNCTION DERF(X)
C--------------------------------------------------------------------
C
...
C--------------------------------------------------------------------
      ...
      real(dp) elemental FUNCTION DERFC(X)
C--------------------------------------------------------------------
C
